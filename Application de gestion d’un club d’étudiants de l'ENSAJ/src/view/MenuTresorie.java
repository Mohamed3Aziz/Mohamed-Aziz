...
/**
 * Date 30/05/2019
 * Il s'agit d'un Menu Tresorier qui sert faire la gestion des cmptabilites ainsi de la consultation
 * @author Pavilion
 *
 */
public class MenuTresorie extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MenuTresorie frame = new MenuTresorie();
	...
	public MenuTresorie() {
		...
		lblTrsorier.setForeground(Color.WHITE);
		lblTrsorier.setFont(new Font("Tahoma", Font.PLAIN, 30));
		lblTrsorier.setBounds(78, 350, 143, 51);
		contentPane.add(lblTrsorier);
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ConsultationEtudiantsTresorie obj = new ConsultationEtudiantsTresorie();
		...
		button_1.setIcon(new ImageIcon(MenuTresorie.class.getResource("/img/Getudiants.png")));
		...
		button_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ConsultationAbsenceTresorier obj = new ConsultationAbsenceTresorier();
		...
		lblGestionDesvnements.setBounds(306, 238, 148, 21);
		contentPane.add(lblGestionDesvnements);
		
		JButton button_3 = new JButton("");
		button_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ConsultationEvenementTresorie obj = new ConsultationEvenementTresorie();
				obj.setPreferredSize(new Dimension(845, 420));
				obj.setUndecorated(true);	    
				obj.pack();
				obj.setVisible(true);
				obj.setLocationRelativeTo(null);
		...
		button_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ConsultationPvTresorie obj = new ConsultationPvTresorie();
				obj.setPreferredSize(new Dimension(695, 420));
				obj.setUndecorated(true);	    
				obj.pack();
				obj.setVisible(true);
				obj.setLocationRelativeTo(null);
		...
		lblGestionDesPvs.setBounds(476, 238, 110, 21);
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				GestionComptabiliteTresorie obj = new GestionComptabiliteTresorie();
		...
		button.setIcon(new ImageIcon(MenuTresorie.class.getResource("/img/Comptabilite.png")));
