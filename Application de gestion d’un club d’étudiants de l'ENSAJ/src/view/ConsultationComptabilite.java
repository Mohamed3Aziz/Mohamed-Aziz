 ...
 * @version 1.0
 */
public class ConsultationComptabilite extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ConsultationComptabilite frame = new ConsultationComptabilite();
	 ...
	 * Creation du frame.
	 */
	public ConsultationComptabilite() {
	...
	/**
	 * Table des gestion comptabilites
	 */
	public void UpdateTabe() {
		String sql = "select paiement,reception,date from comptabilite order by date Asc" ;
		try {
