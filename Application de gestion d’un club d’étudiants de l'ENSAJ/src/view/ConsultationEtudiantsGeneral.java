 ...
 *
 */
public class ConsultationEtudiantsGeneral extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ConsultationEtudiantsGeneral frame = new ConsultationEtudiantsGeneral();
	 ...
	 * Create the frame.
	 */
	public ConsultationEtudiantsGeneral() {
		 ...
		 * @author Pavilion
		 * Telecharger liste des etudiants en format pdf,OneNote etc...
		 */
		new ActionListener() { 
			public void actionPerformed(ActionEvent arg0) {
