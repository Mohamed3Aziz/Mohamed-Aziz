...
/**
 * Date 30/05/2019
 * Il s'agit d'une interface graphique de consultation des evenements
 * @author Pavilion
 *
 */
public class ConsultationEvenementTresorie extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ConsultationEvenementTresorie frame = new ConsultationEvenementTresorie();
	 ...
	 * Create the frame.
	 */
	public ConsultationEvenementTresorie() {
	...
	public void UpdateTabe() {
		String sql = "select nomEvenement,date_debut,date_fin,description from evenement order by date_debut Asc" ;
		try {
