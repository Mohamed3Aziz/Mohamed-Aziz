 ...
 *
 */
public class GestionComptabilite extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GestionComptabilite frame = new GestionComptabilite();
	...
	public GestionComptabilite() {
		 ...
		 * @author Pavilion
		 * ajouter des paiements et des receptions
		 */
		new ActionListener() {
		 ...
		 * @author Pavilion
		 * supprimer des paiements et des receptions
		 */
		new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		 ...
		 * @author Pavilion
		 * modifier des paiements et des receptions
		 */
		new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int ligne = table.getSelectedRow();
		 ...
		 * @author Pavilion
		 * Telecharger la liste des paiments et des receptions dans une format PDF,Onetouche etc ...
		 */
		new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
	...
	/**
	 * table des paiments et des receptions
	 */
