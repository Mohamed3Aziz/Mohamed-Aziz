 ...
 * 
 */
public class ConsultationPv extends JFrame {
	 ...
	 * Create the frame.
	 */
	public ConsultationPv() {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 738, 429);
		...
		lblX.setBounds(707, 0, 44, 14);
		contentPane.add(lblX);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(311, 99, 388, 297);
