...
/**
 * Date 30/05/2019
 * Il s'agit d'une interface de Consultation d'un secreataire
 * @author Pavilion
 *
 */
public class ConsultationComptabiliteSecretaire extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ConsultationComptabiliteSecretaire frame = new ConsultationComptabiliteSecretaire();
	 ...
	 * Creation du frame.
	 */
	public ConsultationComptabiliteSecretaire() {
