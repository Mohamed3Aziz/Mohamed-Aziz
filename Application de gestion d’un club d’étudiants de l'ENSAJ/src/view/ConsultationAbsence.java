...
/** 
 * Date 30/05/2019
 * Il s'agit d'une interface graphique Consultation des absence d'un utilisateur 
 * @author Pavilion
 * 
 * @version 1.0
 */
public class ConsultationAbsence extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ConsultationAbsence frame = new ConsultationAbsence();
