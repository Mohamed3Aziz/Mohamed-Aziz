...
/**
 * Date 30/05/2019
 * Il s'agit d'une interface graphique Consultation des absences d'un Tresorier 
 * @author Pavilion
 * 
 * @version 1.0
 */
public class ConsultationAbsenceTresorier extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ConsultationAbsenceTresorier frame = new ConsultationAbsenceTresorier();
	 ...
	 * Creation du frame.
	 */
	public ConsultationAbsenceTresorier() {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 762, 431);
		...
		lblX.setBounds(715, 0, 44, 14);
		contentPane.add(lblX);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(314, 99, 421, 297);
		...
		btnActualiser.setBounds(314, 54, 129, 34);
		...
		label_2.setBounds(688, 0, 44, 14);
		contentPane.add(label_2);
		
		JButton btnTelecharger = new JButton("Telecharger");
		btnTelecharger.addActionListener(/**
		 * @author Pavilion
		 *  Telecharger liste des absences en format pdf,OneNote etc...
		 */
		new ActionListener() { 
			public void actionPerformed(ActionEvent arg0) {
				MessageFormat header =new MessageFormat("Gestion Absence	");
		...
		btnTelecharger.setBounds(448, 54, 129, 34);
	...
	public void UpdateTabe() { 
		String sql = "select nomEtudiant,date_absence,etat_justification from absence order by date_absence Asc " ;
		try {
