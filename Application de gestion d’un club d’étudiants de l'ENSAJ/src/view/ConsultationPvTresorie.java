...
/**
 * Date 30/05/2019
 * Il s'agit d'une interface graphique de consultation des PVs
 * @author Pavilion
 *
 */
public class ConsultationPvTresorie extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ConsultationPvTresorie frame = new ConsultationPvTresorie();
	 ...
	 * Create the frame.
	 */
	public ConsultationPvTresorie() {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 696, 427);
		...
		lblX.setBounds(674, 0, 44, 14);
		contentPane.add(lblX);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(311, 99, 362, 297);
		...
		label_2.setBounds(647, 0, 44, 14);
		contentPane.add(label_2);
		
		JButton btnTelecharger = new JButton("Telecharger");
		btnTelecharger.addActionListener(/**
		 * @author Pavilion
		 * Telecharger la liste des PVs dans une format PDF,Onetouche etc ...
		 */
		new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
	...
	public void UpdateTabe() {
		String sql = "select numero_reunion,date_reunion,description from reunion order by numero_reunion ASC" ;
		try {
