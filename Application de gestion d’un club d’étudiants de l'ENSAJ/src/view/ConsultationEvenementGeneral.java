 ...
 *
 */
public class ConsultationEvenementGeneral extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ConsultationEvenementGeneral frame = new ConsultationEvenementGeneral();
	 ...
	 * Create the frame.
	 */
	public ConsultationEvenementGeneral() {
